...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='places2_random',
        ...
        # data pattern define
        parser.add_argument('--img_file', type=str, default=r'E:\dataset\inpainting\places2\test.flist',
                            help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='E:\dataset\inpainting\mask\mask2.flist',
                            help='load test mask')
        parser.add_argument('--loadSize', type=int, default=[266, 266],
                            help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=[256, 256],
        ...
        parser.add_argument('--no_shuffle', default=True,help='if true, takes images serial')
