...
class TestOptions(BaseOptions):
    def initialize(self,  parser):
        ...
        parser.add_argument('--results_dir', type=str, default='./results/places2/result2', help='saves results here')
        parser.add_argument('--how_many', type=int, default=3000, help='how many test images to run')
