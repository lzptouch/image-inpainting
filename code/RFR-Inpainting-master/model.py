...
class RFRNetModel():
    ...
    #    writer = SummaryWriter(log_dir="log_info")
        ...
        if finetune:
            self.optm_G = optim.Adam(filter(lambda p:p.requires_grad, self.G.parameters()), lr = 0.001)
    ...
    def test(self, data,test_loader, result_save_path):
        self.G.eval()
        ...
        for items in test_loader:
            ...
            for k in range(comp_B.size(0)):
                ...
                file_path = ('{:s}/'+name).format(result_save_path)
